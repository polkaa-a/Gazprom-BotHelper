...
@Getter
public class ConnectionBudgetButton extends Button {
    public ConnectionBudgetButton(String text, EventType eventType, Map<String, SourceType> source) {
        super(text, Layer.CONNECTION_BUDGET, eventType, source, false, null);
    }
}
